    ...
    <div className="flex flex-col justify-between dark:border-r-2 dark:border-gray-300 bg-white dark:bg-gray-800 h-full overflow-y-scroll min-w-[100%] hide-scrollbar">
      ...
      {user && (
        <Link
          ...
          className="flex my-5 mb-3 gap-2 p-2 items-center bg-white hover:bg-gray-100 dark:bg-gray-900 dark:hover:bg-black dark:text-gray-300 rounded-lg shadow-lg mx-3"
          onClick={handleCloseSidebar}
        >
